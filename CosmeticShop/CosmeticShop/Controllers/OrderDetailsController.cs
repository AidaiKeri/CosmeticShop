...
namespace CosmeticShop.WebApp.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,PriceOnOrderTime,TotalPrice,Amount,OrderId,Id")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,PriceOnOrderTime,TotalPrice,Amount,OrderId,Id")] OrderDetail orderDetail)
        {
