...
namespace E_Shop_Cosmetic.Data
{
    public static class AppDBContextInit
    {
        ...
        private static async Task InitCategories(AppDBContext appDB)
        {
            ...
            {
                new Category {CategoryName="Для лица", Description="Уходовая косметика для лица"},
                new Category {CategoryName="Для тела", Description="Крема для тела"},
                new Category {CategoryName="Для волос", Description="Шампуни и кондиционеры для волос"},
            };
